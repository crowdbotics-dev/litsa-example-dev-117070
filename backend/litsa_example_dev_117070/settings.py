"""
Django settings for litsa_example_dev_117070 project.
...
ROOT_URLCONF = 'litsa_example_dev_117070.urls'
...
WSGI_APPLICATION = 'litsa_example_dev_117070.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "litsa_example_dev_117070 API",
    "DESCRIPTION": "API documentation for litsa_example_dev_117070 App",
    "VERSION": "v1",
}
